...
public class DisplayReservationsServlet extends HttpServlet {
	 ...
	 * Default constructor.
	 */
	public DisplayReservationsServlet() {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if(session.getAttribute(Constants.HTTP_ATT_LOGIN) != null)
		{
			...
			request.setAttribute(Constants.HTTP_ATT_RESERVATIONS, reservationService.findAll());

			String destination = "/WEB-INF/jsp/DisplayReservations.jsp";
